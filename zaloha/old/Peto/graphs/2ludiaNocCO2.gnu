...
set xtics 1525210883, 3600, 1525238515
set grid
...
set output '2ludiaNocCO2.eps'

plot [1525210883:1525238515][400:2100] \
     '2ludiaNocCO2.csv' using 1:2 title "Koncentrácia CO2 (Protronix)" with lines
