...
if __name__ == '__main__':
    ...
    dw1 = storage.download_data_for_normalization(type_id='temperature_in')
    dw2 = storage.download_data_for_normalization(type_id='humidity_in')
    dw3 = storage.download_data_for_normalization(type_id='temperature_out')
    dw4 = storage.download_data_for_normalization(type_id='humidity_out')
    client.logout()
