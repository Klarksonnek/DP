    ...
    for event in events:
        ...
        values = [
            ...
            ('rozdiel_spec_rh', round(abs(
                norm_values_hum_in[0]['specific_humidity'] - norm_values_hum_out[0]['specific_humidity']), precision)),

            ('alpha', round(dp.find_module(event, 'humidity_in')['lin_reg']['first_drop_lin_reg']['alpha'], precision)),
...
if __name__ == '__main__':
    ...
    for i in range(0, len(filtered)):
        if filtered[i]['graph_hum_type_1'] == "none":
            filtered[i]['graph_hum_type_1'] = "linearni"
