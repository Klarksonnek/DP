...
def prepare_derivation(con, events: list, intervals_before: list, intervals_after: list,
    ...
    for i in range(0, len(events)):
        ...
        open_value = event['measured']['rh_in_specific_g_kg'][0]
        no_event_open_value = event['no_event_values'][11]
        ...
        for interval in intervals_before:
            ...
            value = Storage.one_row(con, table_name, 'rh_in_specific_g_kg', value_time)
...
def main(events_file: str, interval_before: list, interval_after: list,
    ...
    filtered = FilterUtil.min_time_interval(filtered, 300)

    # pocitanie derivacii
    logging.info('start computing of derivation')
    prepare_derivation(con, filtered, interval_before, interval_after, table_name, 10)
...
if __name__ == '__main__':
    ...
    interval = [180, 270, 360]
    main('examples/events_klarka_shower.json', interval, interval, -18000)
